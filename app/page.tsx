...
export default async function Home() {
  ...
  return (
    <div className='min-h-screen w-full lg:w-[80vw] mx-auto px-2'>
      <h1 className='text-3xl lg:text-5xl text-center mt-12 body-font font-bold text-zinc-500 dark:text-zinc-300 '>
      ...
      <div className='px-2'>
        <h5 className='text-sm lg:text-xl text-justify md:text-center mt-6 lg:mt-12 body-font  text-zinc-400 '>
          ...
          travel experiences. Our goal is to help travelers discover the beauty
          of Maldivian island life while supporting local communities and
          businesses
        </h5>
      </div>
      <div className='mt-12 '>
